        ...
        <div className="container flex items-center justify-between h-14 gap-3">
          ...
          <div className="flex items-center gap-3 sm:gap-5 min-w-0">
            {typeof step === "number" && typeof total === "number" && (
              <span className="font-mono text-[11px] uppercase tracking-[0.16em] sm:tracking-[0.18em] text-cream/50 tabular-nums">
            ...
            {back && (
              <Link
                to={back.to}
                className="inline-flex items-center gap-1.5 font-ui text-xs uppercase tracking-[0.14em] sm:tracking-[0.16em] text-cream/60 hover:text-cream transition-colors"
              >
