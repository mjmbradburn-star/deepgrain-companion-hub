...
export type Tier = "Dormant" | "Reactive" | "Exploratory" | "Operational" | "Integrated" | "AI-Native";

const tierStyles: Record<Tier, string> = {
  Dormant:      "bg-pillar-8/20 text-cream-dim ring-pillar-8/40",
  Reactive:     "bg-pillar-7/15 text-pillar-7 ring-pillar-7/30",
  Exploratory:  "bg-pillar-2/15 text-pillar-2 ring-pillar-2/30",
  Operational:  "bg-pillar-5/15 text-pillar-5 ring-pillar-5/30",
...
const tierIndex: Record<Tier, number> = {
  Dormant: 0, Reactive: 1, Exploratory: 2, Operational: 3, Integrated: 4, "AI-Native": 5,
};
