-- Add new slice columns
ALTER TABLE public.benchmarks_materialised
...
CREATE INDEX IF NOT EXISTS idx_benchmarks_function ON public.benchmarks_materialised (function);
CREATE INDEX IF NOT EXISTS idx_benchmarks_region ON public.benchmarks_materialised (region);

-- Recompute now considers function + region as additional grouping dimensions
