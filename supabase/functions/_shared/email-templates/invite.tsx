  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={eyebrow}>Issue 01 · Invitation</Text>
        <Heading style={h1}>You're invited.</Heading>
        <Hr style={brassUnderline} />

        <Text style={text}>
          You've been invited to join <Link href={siteUrl} style={link}><strong>{siteName}</strong></Link>. Accept to create your account and begin.
        </Text>
        ...
        <Hr style={hairline} />
        <Text style={footer}>
          Not expecting this invitation? You can safely ignore the email.
        </Text>
      </Container>
    </Body>
  </Html>
