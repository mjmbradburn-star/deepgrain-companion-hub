  ...
  <Html lang="en" dir="ltr">
    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Text style={eyebrow}>Issue 01 · Sign in</Text>
        <Heading style={h1}>Your sign-in link.</Heading>
        <Hr style={brassUnderline} />

        <Text style={text}>
          Open the link to return to your AI Operating Archetype and continue the deeper read. It expires shortly and can only be used once.
        </Text>
